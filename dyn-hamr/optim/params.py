...
class CameraParams(Params):
    ...
    def set_cameras(
        ...
        # print(intrins.shape, cam_R.shape, cam_t.shape)
        # torch.Size([128, 4]) torch.Size([128, 3, 3]) torch.Size([128, 3])
    ...
    def get_cameras(self, idcs=None):
        ...
        # print(cam_R.shape, cam_t.shape, cam_f.shape, cam_center.shape)
        # print(B, self.batch_size)
        # raise ValueError
        # torch.Size([2, 128, 3, 3]) torch.Size([2, 128, 3]) torch.Size([128, 2]) torch.Size([128, 2])
        # 2 2
